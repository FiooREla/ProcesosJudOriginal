...
namespace Sistema.UI.Judicial
{
    public partial class FActoProcesalArbitralEdit : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FActoProcesalArbitralEdit(ActoProcesal oActoProcesal, ContextoModelo ctxModelo, string TextoInstancia,string sContenido, EntityCollection<ExpedienteInstancia> lInstanciass)
